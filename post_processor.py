...
def plot_1D_results(output_paths, plot_column_name, y_axis_title, plot_title):
	...
	fontsize = 20
	for this_item in output_paths.keys():
	    this_path = f'param_exp_1/outdata_{this_item}/eplusout.csv'
	    ...
	    axs.plot(date_list, this_y, alpha = 0.7, linestyle = '-', linewidth = 2, label = this_item)
	    ...
	    plt.savefig('param_exp_1/final.png',bbox_inches='tight')